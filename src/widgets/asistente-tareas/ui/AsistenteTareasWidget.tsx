...
import { TareaBanner } from './TareaBanner';
import { TablaBorradores } from './TablaBorradores';
import { TAREAS_DEMO } from '../model/tareas';

const TABLA = <TablaBorradores />;
...
export function AsistenteTareasWidget() {
